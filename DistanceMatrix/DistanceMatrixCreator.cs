...
namespace DistanceMatrixNamespace
{
    ...
    {
        private List<Location> OriginAddresses { get; set; }
        private List<Location> DestinationAddresses { get; set; }
        public TimeSpan[,] DistanceMatrixValues { get; set; }
        ...
        public List<TimeSpan> this[int key]
        {
            get
            {
                TimeSpan[] arraySlice = DistanceMatrixValues.GetRow(key);
